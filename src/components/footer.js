...
class Footer extends React.Component {
	render() {
		return (<footer>
			...
			<div class="headersections" id="passage">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none"><path d="M7.5.5l-7 23M15.5.5l7 23M11.5 19.5v4M11.5 11.5v4M11.5 4.5v3M11.5.5v1"/></g></svg>
			</div>
			<div><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" fill="none"><path d="M1.297 1.453l13.293 3.319c1.601.4 2.91 2.077 2.91 3.728v12c0 1.65-1.314 2.69-2.92 2.312l-11.16-2.624c-1.606-.379-2.92-2.038-2.92-3.688v-13c0-1.651 1.35-3 3-3h17c1.65 0 3 1.349 3 3v11c0 1.65-1.35 3-3 3h-3M9.5 3.5h10"/><circle cx="13" cy="13.5" r="2"/><path d="M17.5 8.5h2"/></g></svg></div>
		</footer>)
	}
}
