...
class Header extends React.Component {
	...
	render(){
		...
		return (<header className="homeheader" style={{width:"100%", height:"11%", display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"space-around"}} id={this.props.id} link={this.props.link}>
