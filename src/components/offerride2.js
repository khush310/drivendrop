...
class OfferRide2 extends React.Component {
	...
	render() {
		...
		const sectionStyle = Object.assign({},center, {marginTop:"2em", width:"86%", height:"65%", flexDirection:"column", background:"rgba(158, 158, 158, 0.5)", boxShadow:"0 1px 3px 0 rgba(0, 0, 0, 0.4), inset 0 1px 0 0 rgba(255, 255, 255, 0.47)" });
		...
		return (<div className={classes}>
			<section className="offersection2" style={sectionStyle}>
				<ul style={{width: "100%", height: "75%", padding: "0", margin:"0", display: "flex",flexDirection:"column", listStyle:"none"}}>
					<li id="selectSeats">
